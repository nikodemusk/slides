...
@snap[west span-55]
![](https://cloudheaven.se/~nikodemus/shared/waveslides/TravellingWave.gif)
@size[0.4em](Periodtid $T$, frekvens $f$ och våglängd $\lambda$: Under en periodtid så snurrar hjulet ett varv. På samma tid hinner också vågen bre ut sig med sträckan en våglängd, avståndet mellan två vågtoppar. Frekvensen är hur många varv hjulet roterar under en sekund.)
@snapend
