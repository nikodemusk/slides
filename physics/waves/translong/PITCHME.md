...
@box[bg-green rounded box-padding](@size[0.7em](Varje del på strängen rör sig enbart i uppåt- nedåtriktning medan utbredningen sker i sidled.))
@snapend

@snap[east span-35]
<br><br>
@box[bg-green rounded box-padding](@size[0.4em](För en transversell våg gäller att utbredningsriktningen och partiklarnas rörelseriktningar är vinkelräta mot varandra.))
@snapend
